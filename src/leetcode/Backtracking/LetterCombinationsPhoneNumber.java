...
public class LetterCombinationsPhoneNumber {
	...
	public static void main(String[] args){
		List<String> ans = letterCombinationsRecursive("123");
		for(String s : ans){
	...
	private static void combine(List<String> res, String digits, StringBuilder sb, int pos) {
		if (pos == digits.length()) {
			...
			for (int i = 0; i < letters.length(); i++) {
				combine(res, digits, sb.append(letters.charAt(i)), pos + 1);
